...
parser.add_argument('--model', type=str, required=False, default='ppo_per',
                    help="two models are available ['ppo', 'ppo_per']")
...
if args.model == 'ppo_per':
    from not_recommended_implement.ppo_per import PPOAgent
else:
    from not_recommended_implement.ppo_rc import PPOAgent
...
plt.xlabel('epoch')
plt.ylabel('SEE')
plt.savefig('./reward_png/SEE_ppo_per.png')
